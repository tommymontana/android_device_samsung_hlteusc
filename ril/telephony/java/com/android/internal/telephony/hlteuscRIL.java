 ...
 * {@hide}
 */
public class hlteuscRIL extends RIL implements CommandsInterface {
    ...
    public hlteuscRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        this(context, preferredNetworkType, cdmaSubscription);
    }

    public hlteuscRIL(Context context, int networkMode,
